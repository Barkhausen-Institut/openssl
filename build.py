def build(gen, env):
    ...
    # build libcrypto.a; this list is obtained from a Linux build for ARM and slightly adjusted.
    crypto_files = [
        './crypto/mem_clr.c',
        ...
        # './crypto/aes/aesv8-armx.c',
        # './crypto/aes/vpaes-armv8.c',
        './crypto/aria/aria.c',
        # './crypto/arm64cpuid.c',
        # './crypto/armcap.c',
        ...
        # './crypto/ec/ecp_nistz256-armv8.c',
        ...
        # './crypto/poly1305/poly1305-armv8.c',
        ...
        # './crypto/sha/keccak1600-armv8.c',
        # './crypto/sha/sha1-armv8.c',
        './crypto/sha/sha1_one.c',
        './crypto/sha/sha1dgst.c',
        # './crypto/sha/sha256-armv8.c',
        './crypto/sha/sha256.c',
        # './crypto/sha/sha512-armv8.c',
        './crypto/sha/sha512.c',
